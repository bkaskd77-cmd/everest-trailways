...
export const TREK_PAGES: Trek[] = [
  {
    ...
    seasonality: months([
      [1, "possible", "Cold and clear. Nights at Gorak Shep run to minus twenty and several high teahouses close, so the route runs on fewer beds."],
      [2, "possible", "Still cold, still clear, and quieter than any other month the route is walkable. Snow on the Namche climb is normal."],
      [3, "good", "Warming, and the spring crowd has not arrived. Cloud builds in the afternoon from the middle of the month."],
      [4, "best", "The busiest month with October. Clear mornings, full teahouses, and Lukla flights moved to Ramechhap for the season."],
      [5, "good", "Warm and increasingly hazy. The mountains are often gone by ten in the morning. Fewer people than April."],
      [6, "avoid", "Monsoon. Cloud to the valley floor, leeches below Namche, and Lukla flights grounded for days at a time."],
      [7, "avoid", "The wettest month. We do not run this route in July."],
      [8, "avoid", "Monsoon, with the added risk of landslides on the walk-in. We do not run this route in August."],
      [9, "possible", "The monsoon withdraws through the month. The last week is often clear and the trail is nearly empty."],
      [10, "best", "The clearest month of the year and the busiest. Book beds and flights months ahead; expect Ramechhap rather than Kathmandu."],
      [11, "best", "Clear, cold and thinning out as the month goes on. The last fortnight is the best combination of weather and space on the trail."],
      [12, "possible", "Very cold and very clear. Some high teahouses have closed for the winter by mid-month."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "possible", "Cold and often clear, with snow on the last two days into the sanctuary. The avalanche section is watched closely."],
      [2, "good", "Cold, clearing, and quiet. Rhododendron has not started and the forest is bare."],
      [3, "best", "Rhododendron flowers through the forest from mid-month and the trail is dry. Busy but not at its worst."],
      [4, "best", "The clearest spring weather and the heaviest traffic. Teahouses in the sanctuary fill by early afternoon."],
      [5, "good", "Warm, green and increasingly hazy. Afternoon cloud closes the sanctuary most days by two."],
      [6, "avoid", "Monsoon. Leeches from Bamboo upward, and the Modi Khola crossings run high."],
      [7, "avoid", "The wettest month, with landslide risk on the jeep road to the trailhead. We do not run this route in July."],
      [8, "avoid", "Monsoon. We do not run this route in August."],
      [9, "good", "Wet at the start, clear and green by the end, and quiet throughout. Leeches persist in the lower forest."],
      [10, "best", "The clearest month and the busiest. Beds in the sanctuary need booking days ahead."],
      [11, "best", "Cold, dry and steadily quieter. The best month for anyone who wants the route without the queue."],
      [12, "possible", "Cold, short days, and the first serious snow on the upper section."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "avoid", "Thorong La is usually closed by snow. The route runs as an out-and-back on the Manang side or not at all."],
      [2, "possible", "The pass opens intermittently late in the month. Cold, clear, and very few people."],
      [3, "good", "The pass is usually open by mid-month. The lower Marsyangdi is warm and the upper valley is still cold."],
      [4, "best", "The most reliable crossing weather and the busiest month. Thorong Phedi fills and the pass is walked in single file before dawn."],
      [5, "good", "Warm and hazy on the Marsyangdi side, dry and windy on the Mustang side. The pass is dependable."],
      [6, "avoid", "Monsoon on the southern half, with landslide risk on the Besisahar road. We do not run this route in June."],
      [7, "avoid", "The wettest month on the approach. We do not run this route in July."],
      [8, "avoid", "Monsoon. We do not run this route in August."],
      [9, "possible", "Clearing through the month. The pass is usually crossable from the middle, and the trail is empty."],
      [10, "best", "The clearest month, the most reliable pass, and the largest crowd. Manang is full."],
      [11, "best", "Cold, dry and steadily quieter. The pass stays open most of the month and closes without warning after."],
      [12, "possible", "Cold and short. The pass may close for the season at any point and we say so before you book."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "possible", "Cold and clear, with snow above Langtang village. The road is the risk rather than the trail."],
      [2, "possible", "Cold and quiet. The upper valley holds snow and the day walk above Kyanjin Gompa may not be possible."],
      [3, "good", "Warming, with rhododendron in the lower forest from late in the month."],
      [4, "best", "Clear mornings and the valley at its greenest. Busier than usual but still quiet by Nepali standards."],
      [5, "good", "Warm and hazy, with afternoon cloud filling the valley most days."],
      [6, "avoid", "Monsoon, and the Syabrubesi road is the first in the country to close. We do not run this route in June."],
      [7, "avoid", "The wettest month, with active landslide risk on the approach. We do not run this route in July."],
      [8, "avoid", "Monsoon. We do not run this route in August."],
      [9, "possible", "Clearing late. The road remains the limiting factor into the middle of the month."],
      [10, "best", "The clearest month. The valley is busier than the rest of the year and still emptier than Annapurna."],
      [11, "best", "Cold, dry and very quiet. The best month here for anyone who wants the valley to themselves."],
      [12, "possible", "Cold and short-dayed. Some upper teahouses close for the winter."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "avoid", "Bitter and largely shut. Most guesthouses north of Kagbeni close for the winter."],
      [2, "avoid", "Still closed in practice. The plateau is cold enough that the villages empty out."],
      [3, "possible", "Opening up late in the month. Cold, very windy, and almost nobody there."],
      [4, "best", "The plateau is open, the light is clear, and the Jomsom flights are at their most reliable."],
      [5, "best", "Warm days, cold nights, and the strongest wind of the year through the Kali Gandaki each afternoon."],
      [6, "good", "The monsoon largely misses this side of the range, which makes it one of the few routes worth walking now. Getting here is the problem."],
      [7, "good", "Dry on the plateau and wet on the approach. The Jomsom flight is unreliable and the road alternative is long."],
      [8, "good", "Dry here, monsoon everywhere between here and Kathmandu. Build in spare days at both ends."],
      [9, "good", "The approach clears and the plateau is still dry. A good month, and quiet."],
      [10, "best", "Clear, dry and busy by Mustang standards, which is a handful of groups rather than a queue."],
      [11, "good", "Cold and clear. Villages begin closing towards the end of the month."],
...

  {
    ...
    seasonality: months([
      [1, "good", "Cold mornings and the most reliable views of the year. Frost on the Ghorepani steps before dawn."],
      [2, "good", "Cold, clear and quiet. The forest is bare and the ridge is sharp."],
      [3, "best", "Rhododendron in flower through the forest between Ghorepani and Tadapani. The reason to come this month."],
      [4, "best", "Warm, green and busy. Ghorepani fills every night and the viewpoint is crowded at dawn."],
      [5, "possible", "Hazy. The viewpoint is often a white sky, and the forest is warm and humid."],
      [6, "avoid", "Monsoon. Leeches through the forest and no view at all. We do not run this route in June."],
      [7, "avoid", "The wettest month. We do not run this route in July."],
      [8, "avoid", "Monsoon. We do not run this route in August."],
      [9, "good", "Wet early and clear late, with the forest at its greenest and almost nobody on the trail."],
      [10, "best", "The clearest month and the busiest. Beds at Ghorepani need booking ahead."],
      [11, "best", "Clear, cool and thinning through the month. The best combination of view and space."],
      [12, "good", "Cold and clear with short days. Quiet on the trail and cold on the pre-dawn climb."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "possible", "Cold and clear, with snow on the ridge above Low Camp and the high point often out of reach."],
      [2, "possible", "Cold and very quiet. High Camp runs on fewer lodges through the winter."],
      [3, "good", "Rhododendron in the forest below Low Camp from mid-month, and the ridge clearing."],
      [4, "best", "The clearest spring month. High Camp fills, which on this route means four lodges rather than a village."],
      [5, "good", "Warm and hazy, with cloud coming up the ridge by late morning most days."],
      [6, "avoid", "Monsoon. The ridge is in cloud and the forest is leeched. We do not run this route in June."],
      [7, "avoid", "The wettest month. We do not run this route in July."],
      [8, "avoid", "Monsoon. We do not run this route in August."],
      [9, "possible", "Clearing late in the month, green, and almost empty."],
      [10, "best", "The clearest month and the only one where beds at High Camp genuinely need booking ahead."],
      [11, "best", "Cold, dry and quiet. The best month on this ridge."],
      [12, "possible", "Cold and short. Snow on the high point becomes likely towards the end of the month."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "best", "Cool, dry and clear. Grass is still high early in the month, which makes sighting harder than February."],
      [2, "best", "Cool days, cut grass, and the best visibility of the year for large animals."],
      [3, "good", "Warming and dry. Animals concentrate near water, which improves the odds and lengthens the drives."],
      [4, "possible", "Hot. Sightings are good at water but the middle of the day is hard work and the lodge has no air conditioning."],
      [5, "possible", "The hottest month before the rain. Excellent at the river, punishing away from it."],
      [6, "avoid", "The monsoon starts and the park largely closes. We do not run this trip in June."],
      [7, "avoid", "Flooding on the Rapti. The park is closed. We do not run this trip in July."],
      [8, "avoid", "Monsoon and flooding. We do not run this trip in August."],
      [9, "avoid", "The park reopens late in the month at best, with grass too high to see through. We do not run this trip in September."],
      [10, "good", "Reopened, green and humid, with very high grass. Fewer people than the winter."],
      [11, "best", "Dry, cooling, and the grass beginning to be cut. A strong month."],
      [12, "best", "Cool and dry with the clearest air of the year. Mornings are cold in an open jeep."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "good", "Cool and dry, with morning fog that closes the flight some days. Excellent conditions once you are there."],
      [2, "best", "Cool, clear and dry, with grass cut and visibility at its best."],
      [3, "best", "Warming, dry, and the strongest tiger months begin. Animals concentrate on the Karnali."],
      [4, "best", "Hot and dry, and the best chance of the year at water. Middle of the day is severe."],
      [5, "good", "The hottest month. Sightings stay good and the heat is genuinely hard."],
      [6, "avoid", "Monsoon. The park closes and the roads west become unreliable. We do not run this trip in June."],
      [7, "avoid", "Flooding on the Karnali. We do not run this trip in July."],
      [8, "avoid", "Monsoon. We do not run this trip in August."],
      [9, "avoid", "Grass too high to see through and the park only partly open. We do not run this trip in September."],
      [10, "possible", "Reopening, green, humid, with very high grass and poor visibility."],
      [11, "good", "Drying out and cooling. Grass still high early in the month."],
      [12, "good", "Cool and dry, with fog on the flight some mornings and cold starts in an open jeep."],
    ]),
    heroImage: {
...

  {
    ...
    seasonality: months([
      [1, "possible", "Cold mornings and the worst air of the year. The ridges are pleasant and the view is often gone."],
      [2, "possible", "Cold and hazy. Air quality is the limiting factor rather than the weather."],
      [3, "good", "Warming, with the pre-monsoon burning season starting to affect visibility late in the month."],
      [4, "good", "Warm and green, with better air than winter and afternoon cloud building."],
      [5, "possible", "Hot and humid on the lower sections, with storms most afternoons."],
      [6, "avoid", "Monsoon. The tracks turn to mud and there is nothing to see. We do not run this trip in June."],
      [7, "avoid", "The wettest month. We do not run this trip in July."],
      [8, "avoid", "Monsoon. We do not run this trip in August."],
      [9, "good", "Clearing, green, and the cleanest air of the year as the rain washes the valley."],
      [10, "best", "The clearest month. Terraces are cut and the high peaks are visible from the rim most mornings."],
      [11, "best", "Clear, cool and dry, with the best light of the year over the valley."],
      [12, "good", "Cold and clear early in the month, hazier as the winter inversion settles in."],
    ]),
    heroImage: {
