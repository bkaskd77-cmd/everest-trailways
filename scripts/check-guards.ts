...
console.log(
  `    ${counts.structural} structural — the compiler forbids the failing shape`,
);
console.log(
  `    ${counts.adjacent} adjacent — a sibling rule on the same path is mutated`,
);
